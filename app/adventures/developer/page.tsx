...
const experiences: DeveloperExperience[] = [
  {
    id: "terminal",
    title: "The Terminal",
  ...
  },
  {
    ...
    description: "Clean, professional layout. Works for everyone.",
    icon: "🎯",
...
export default function DeveloperAdventuresPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
      <div className="container mx-auto px-4 py-16">
        ...
        >
          ...
          <h1 className="text-5xl font-bold mb-4">Developer Adventures</h1>
          <p className="text-xl text-purple-200 mb-2">
            Choose Your Experience
          </p>
          <p className="text-sm text-gray-300 max-w-2xl mx-auto">
            Interactive, technical experiences designed for developers and tech enthusiasts.
            Each offers a unique way to explore the same content.
          </p>
        </motion.div>
        ...
        >
          <p>
            ...
            <Link href="/classic" className="text-purple-400 hover:text-purple-300 underline">
              Classic View
            </Link>{" "}
          ...
          <p className="mt-2">
            ...
            <Link href="/adventures/business" className="text-blue-400 hover:text-blue-300 underline">
              Switch to Business Path
            </Link>
          </p>
        </motion.div>
      </div>
